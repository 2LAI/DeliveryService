...
public class StoreRepository {
    ...
    public static Integer numberOfPositionInDB = 15;
    ...
    public static void initializeStoreRepository() {
        ...
        productList1.add(4, new Position(6, ProductRepository.productList.get(0), "Pasta - Milk", 27.7, 6));
        productList1.add(5, new Position(7, ProductRepository.productList.get(0), "Pasta - Milk", 28.7, 6));
        productList1.add(6, new Position(8, ProductRepository.productList.get(0), "Pasta - Milk", 29.7, 6));

        List<Position> productList2 = new ArrayList<>();
        productList2.add(0, new Position(9, ProductRepository.productList.get(3), "Pasta - Italyano", 11.5, 8));
        productList2.add(1, new Position(10, ProductRepository.productList.get(3), "Pasta - Italyano 2", 18.7, 3));

        List<Position> productList3 = new ArrayList<>();
        productList3.add(0, new Position(11, ProductRepository.productList.get(3), "Pasta - Italyano", 13.2, 21));
        productList3.add(1, new Position(12, ProductRepository.productList.get(3), "Pasta - Italyano 2", 17.7, 12));

        List<Position> productList4 = new ArrayList<>();
        productList4.add(0, new Position(13, ProductRepository.productList.get(3), "Pasta - Italyano", 13.7, 22));
        productList4.add(1, new Position(14, ProductRepository.productList.get(3), "Pasta - Italyano 2", 12.7, 10));
