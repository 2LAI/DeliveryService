...
public class StoreRepository {
    ...
    public static void initializeStoreRepository() {
        ...
        productList.add(0, new Position(counter, ProductRepository.productList.get(0), "Some description", 14.4, 3));
        productList.add(1, new Position(counter, ProductRepository.productList.get(1), "Orange Juice", 18.4, 10));

        List<Position> productList1 = new ArrayList<>();
        productList1.add(0, new Position(counter, ProductRepository.productList.get(2), "Pasta - Italyano", 10.6, 2));
        productList1.add(1, new Position(counter, ProductRepository.productList.get(3), "Pasta - Italyano 2", 16.7, 5));
        productList1.add(2, new Position(counter, ProductRepository.productList.get(4), "Pasta - Italyano 3", 26.7, 6));
        productList1.add(3, new Position(counter, ProductRepository.productList.get(5), "Pasta - Milk", 26.7, 6));
        productList1.add(4, new Position(counter, ProductRepository.productList.get(5), "Pasta - Milk", 27.7, 6));
        ...
        productList2.add(0, new Position(counter, ProductRepository.productList.get(2), "Pasta - Italyano", 11.5, 8));
        ...
        productList3.add(0, new Position(counter, ProductRepository.productList.get(1), "Pasta - Italyano", 13.2, 21));
        ...
        productList4.add(0, new Position(counter, ProductRepository.productList.get(2), "Pasta - Italyano", 13.7, 22));
        productList4.add(1, new Position(counter, ProductRepository.productList.get(2), "Pasta - Italyano 2", 12.7, 10));
